            ...
            <table class="w-full">
                <thead>
                    <tr class="text-gray-600 text-sm border-b">
                        <th class="py-3 text-center">Kode</th>
                        <th class="py-3">Nama Jurusan</th>
                        <th class="py-3 text-left pl-7">Aksi</th>
                    </tr>
                </thead>
                ...
                <tbody class="text-sm">
                    @forelse ($data as $item)
                        <tr class="border-b text-center hover:bg-gray-50">
                            <td class="py-3 text-center">{{ $item->kode_jurusan }}</td>
                            <td class="py-3 text-center">{{ $item->nama_jurusan }}</td>

                             <td class="py-3 flex text-center items-center gap-2">
